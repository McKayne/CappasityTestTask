...
import com.el_nico.cappasitytesttask.models.database.ForecastQueryResult
import com.el_nico.cappasitytesttask.models.database.OneCallQueryResult
import com.el_nico.cappasitytesttask.models.database.WeatherQueryResult
        ...
        when (type) {
            ...
            WeatherDetailsType.ONECALL -> {
                ...
                if (latitude is Double && longitude is Double
                    ...
                    shouldPresentLoadingIndicator.value = false
                    shouldPresentMessage.value = "Не указаны координаты!"
                }
            }
        }
    }
