...
class WeatherDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.addFragment(createWeatherFragment(WeatherDetailsType.WEATHER), "Погода сейчас")
        adapter.addFragment(createWeatherFragment(WeatherDetailsType.FORECAST), "Прогноз на 5 дней")
        adapter.addFragment(createWeatherFragment(WeatherDetailsType.ONECALL), "Прогноз на неделю")
